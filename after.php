...
<div class="modal-overlay">
    <div class="modal">
        ...
        <p>An appointment has been made please check your email.Thank you for choosing us</p>
...
<script>
    ...
    function shouldShowModal() {
        return !localStorage.getItem('dismissModal');
    }
    ...
    dismissModal.addEventListener('change', dismissModalHandler);
